...
async function handleBriefingApprove(req, res) {
  try {
    ...
    if (RESEND_KEY) {
      const clientHtml = [
        "<!doctype html><html><head><meta charset=\"utf-8\"/>",
        "<title>Tu briefing con Habitaris</title>",
        "<style>",
        "@import url('https://fonts.googleapis.com/css2?family=Outfit:wght@300;400;500;600;700&display=swap');",
        "body{margin:0;padding:0;background:#f3f0ff;font-family:'Outfit',-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;color:#111;}",
        ".wrap{max-width:600px;margin:32px auto;padding:0 16px;}",
        ...
        "h1{font-size:22px;font-weight:600;margin:0 0 12px 0;color:#111;}",
        "p{font-size:15px;line-height:1.6;margin:0 0 16px 0;color:#333;}",
        ".cta-box{background:#f3f0ff;border-left:3px solid #111;border-radius:6px;padding:20px;margin:24px 0;text-align:center;}",
        ".btn{display:inline-block;padding:14px 32px;background:#111;color:#fff!important;border-radius:6px;font-size:14px;font-weight:500;text-decoration:none;}",
        ...
        "<div class=\"header\"><img src=\"https://suite.habitaris.es/logo-habitaris.jpg\" alt=\"Habitaris\"/></div>",
        "<div class=\"body\">",
        "<h1>Tu briefing con Habitaris esta listo</h1>",
        "<p>Hola " + briefingEscape(reqRow.nombre_completo || "") + ",</p>",
        "<p>Gracias por confiar en nosotros. A continuacion encontraras el enlace a tu briefing personalizado. Rellenalo con calma para que podamos entender mejor tu proyecto.</p>",
        "<div class=\"cta-box\">",
        "<a href=\"" + clientUrl + "\" class=\"btn\">Comenzar mi briefing</a>",
        "<div class=\"note\">El enlace es valido durante 48 horas y permite hasta 2 sesiones para completarlo.</div>",
        "</div>",
        "<p>Si tienes cualquier pregunta, responde directamente a este correo o escribenos a comercial@habitaris.es. Estaremos encantados de ayudarte.</p>",
        "</div>",
        "<div class=\"footer\">Habitaris S.A.S &middot; NIT 901.922.136-8 &middot; Bogota D.C., Colombia &middot; +57 350 566 1545<div class=\"sub\">Si tienes cualquier duda, escribenos a comercial@habitaris.es</div></div>",
        "</div></div></body></html>"
      ].join("");
