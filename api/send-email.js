...
async function handleBriefingRequest(req, res) {
  try {
    ...
    const emailHtml = [
      ...
      "body { margin:0; padding:0; background:#f3f0ff; font-family:'Outfit',-apple-system,BlinkMacSystemFont,'Segoe UI',Helvetica,Arial,sans-serif; color:#111; }",
      ".wrapper { padding:32px 16px; }",
      ".card { max-width:560px; margin:0 auto; background:#ffffff; border-radius:8px; overflow:hidden; }",
      ".header { background:#ffffff; padding:24px; text-align:center; border-bottom:1px solid #eeeeee; }",
      ".header img { display:inline-block; height:50px; }",
      ".content { padding:32px 28px; }",
      "h1 { font-size:22px; font-weight:700; margin:0 0 12px 0; color:#111; letter-spacing:-0.01em; }",
      "p { font-size:15px; line-height:1.55; margin:0 0 16px 0; color:#333; }",
      ".datos { background:#f3f0ff; border-left:3px solid #111; padding:20px 22px; margin:20px 0 24px 0; border-radius:0 6px 6px 0; }",
      ".datos .label { font-size:11px; font-weight:600; letter-spacing:0.08em; text-transform:uppercase; color:#666; margin-bottom:4px; }",
      ".datos .val { font-size:15px; color:#111; margin-bottom:14px; word-break:break-word; }",
      ".datos .val:last-child { margin-bottom:0; }",
      ".buttons { text-align:center; margin:28px 0 12px 0; }",
      ".btn { display:inline-block; padding:13px 26px; border-radius:6px; font-size:14px; font-weight:600; text-decoration:none; margin:0 6px; }",
      ".btn-approve { background:#111111; color:#ffffff !important; }",
      ".btn-reject { background:#ffffff; color:#111111 !important; border:1px solid #cccccc; }",
      ".helper { font-size:12px; color:#888; text-align:center; margin-top:18px; line-height:1.5; }",
      ".footer { max-width:560px; margin:24px auto 0 auto; padding:0 16px; text-align:center; }",
      ".footer .legal { font-size:12px; color:#888; line-height:1.5; }",
      ".footer .contact { font-size:12px; color:#888; margin-top:4px; }",
      "</style></head><body>",
      "<div class=\"wrapper\">",
      "<div class=\"card\">",
      ...
      "<div class=\"datos\">",
      "<div class=\"label\">Nombre</div><div class=\"val\">", briefingEscape(nombre), "</div>",
      "<div class=\"label\">Email</div><div class=\"val\">", briefingEscape(email), "</div>",
      "<div class=\"label\">Telefono</div><div class=\"val\">", briefingEscape(telefono), "</div>",
      mensaje ? ("<div class=\"label\">Mensaje</div><div class=\"val\">" + briefingEscape(mensaje) + "</div>") : "",
      "</div>",
      "<div class=\"buttons\">",
      "<a href=\"", approveUrl, "\" class=\"btn btn-approve\">Aprobar y enviar</a>",
      "<a href=\"", rejectUrl, "\" class=\"btn btn-reject\">Rechazar</a>",
      "</div>",
      "<p class=\"helper\">Si apruebas, el cliente recibe automaticamente su link de briefing (validez 48h, 2 usos).<br/>Estos botones expiran en 48 horas. Si los dos aprobadores hacen clic, gana el primero.</p>",
      "</div></div>",
      "<div class=\"footer\">",
      "<div class=\"legal\">Habitaris S.A.S &middot; NIT 901.922.136-8 &middot; Bogota D.C., Colombia &middot; +57 350 566 1545</div>",
      "<div class=\"contact\">Si tienes cualquier duda, escribenos a comercial@habitaris.es</div>",
      "</div>",
      "</div>",
      "</body></html>"
    ].join("");
