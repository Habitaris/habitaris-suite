              ...
              <div key={i} style={{display:"flex",alignItems:"center",gap:14,padding:"14px 16px",background:"#FAFAF8",border:`1px solid ${T.border}`,borderRadius:8,marginBottom:8,cursor:"pointer",transition:"all .15s"}}
                onClick={()=>{
                  ...
                  if(d.action==="anticipo"){
                    ...
                    <div style="text-align:center;margin-bottom:14px"><div style="font-size:8.5pt;color:#555;font-weight:500">${MESES[mes]} ${anio}</div><div style="font-size:7pt;color:#bbb;margin-top:2px">Período: 01 al ${new Date(anio,mes+1,0).getDate()} de ${MESES[mes]} ${anio} · ${selN.tipoContrato}</div></div>
