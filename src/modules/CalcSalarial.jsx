      ...
      <div onClick={e=>e.stopPropagation()} style={{background:"#fff",borderRadius:12,maxWidth:560,width:"100%",maxHeight:"85vh",overflow:"auto",padding:24,boxShadow:"0 8px 30px rgba(0,0,0,.2)"}}>
        ...
        {propForm.modo==="manual"&&<>
          ...
          <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:8}}>
            ...
            </select><input value={propForm.candidato_celular} onChange={e=>upP("candidato_celular",e.target.value)} placeholder="321 2319523" style={{width:"100%",padding:"7px 10px",border:"1px solid #E5E3DE",borderRadius:"0 6px 6px 0",fontSize:12,fontFamily:"'DM Sans',sans-serif"}}/></div></div>
