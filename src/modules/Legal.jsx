...
const PLANTILLAS_SEED = [
  ...
  { id:"tpl_contrato_laboral", cat:"contratos", nombre:"Contrato Individual de Trabajo — Término Fijo",
    ...
    pais:"CO", obligatorio:false,
    firmantes:[{rol:"Revisor legal",obligatorio:true},{rol:"Trabajador",obligatorio:true,auto:true},{rol:"Empleador — Rep. Legal",obligatorio:true,nombre:"Ana María Díaz Buitrago",email:"amdiaz@habitaris.co",doc:"1.109.293.384"}] },
