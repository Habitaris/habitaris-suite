...
import { getTenantLegalRepresentativeSync, getActiveCompanyLegalDataSync } from "../core/configHelpers.js";
...
const PLANTILLAS_SEED = [
  ...
  { id:"tpl_descriptor_cargo", cat:"contratos", nombre:"Descriptor de Cargo",
    ...
    pais:"CO", obligatorio:false,
    firmantes:[{rol:"Trabajador",obligatorio:true,auto:true}] },
...
export default function Legal() {
  ...
  const renderGenDoc = () => {
    ...
    // Auto-fill empresa
    const empresa = getActiveCompanyLegalDataSync();
    const autoVars = { empresa_nombre: empresa.legalName || "Habitaris S.A.S", empresa_nit: empresa.taxId || "",
      rep_legal:"Laura Sánchez Díaz", ciudad: empresa.domicilio?.ciudad || "Bogotá D.C.", fecha:new Date().toLocaleDateString(getTenantDefaultsSync().locale,{ day:"numeric", month:"long", year:"numeric" }) }
