...
export function buildPrimaJustificanteHtml({ selN, prima, anio, refBancaria }) {
  ...
  ${refBancaria?`<div style="font-size:8pt;color:#444;background:#FAFAF7;border:1px solid #ddd;border-left:3px solid #111;border-radius:3px;padding:6px 10px;margin:8px 0">Pagado con referencia: <b>${refBancaria}</b></div>`:""}
