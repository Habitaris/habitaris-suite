...
export default function FormularioPublico() {
  ...
  useEffect(() => {
    ...
    if (cliente) {
      ...
      campos.forEach(c => {
        ...
        if (cliente.tel && cliente.tel.replace(/[^0-9]/g,"").length > 4 && c.mapKey==="telefono") prefill[c.id] = cliente.tel;
      });
  ...
  const isLocked = (c) => {
    ...
    if (cliente.tel && cliente.tel.trim() && cliente.tel.replace(/[^0-9]/g,"").length > 4 && (c.mapKey==="telefono" || c.tipo==="tel_combo")) return true;
